...
export default function Forgotemail() {
    ...
    const handleSubmit = (e) => {
        ...
        setLoader(true)
        const dis = document.getElementById('forgotUsername-btn')
        dis.disabled = true
        const data={
            email , captcha
        }
        axios.post(`${process.env.REACT_APP_DOMAIN}/forgotUsername` , data ).then((res)=>{
            dis.disabled = false
            setLoader(false)
    ...
    return (
        ...
        <div className="mx-auto py-5 forgotPassword-div">
            ...
            <form className="form-group my-0 mx-5" onSubmit={handleSubmit} >
                ...
                <button type="submit" className="btn-lg btn-block btn-primary d-block " id="forgotUsername-btn"  >
